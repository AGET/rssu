...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            captionFormat: '{0} Seleccionado', // format of caption text. you can set your locale.
            captionFormatAllSelected: '{0} Todos seleccionados!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
            ...
            locale: ['Aceptar', 'Cancelar', 'Seleccionar todos'], // all text that is used. don't change the index.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    if (O.E.attr('name'))
                        O.select.addClass('sumo_' + O.E.attr('name'))
