...
<html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="#scrollspy" data-offset="1">
            ...
            <div class="carousel slide" id="miSlider" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="bootstrap/img/img1.jpg" alt="Imagen1" class="imgcarousel">
                        <!-- Agregando txto -->
                        <div class="carousel-caption">
                            <p class="txttitlecarusel">Rastreo</p>
                            <br><br>
                            <p class="txtcarusel">Localización, visibilidad y rastreo de cualquier tipo de vehículo y activos como remolques, plantas de luz,
                                maquinaria pesada, motos, etc.</p>
                            <p class="txtcarusel"></p> 
                            <br><br><br><br>
                        </div>
                    </div>

                    <div class="item">
                        <img src="bootstrap/img/img2.jpg" alt="Imagen2" class="imgcarousel">
                        <div class="carousel-caption">
                            <p class="txttitlecarusel">Optimizacion</p>
                            <br><br>
                            <p class="txtcarusel">Optimización en la logística de operación, que contribuye en una mejor distribución por rutas y tiempos.</p>
                            <br><br><br><br>
                        </div>
                    </div>
                    <div class="item">
                        <img src="bootstrap/img/img3.jpg" alt="Imagen3" class="imgcarousel">
                        <div class="carousel-caption">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <p class="txttitlecarusel">Seguridad</p>
                                    <br><br>
                                </div>
                                <div class="hidden-xs col-sm-12">
                                    <p class="txtcarusel">Seguridad y control de los recursos materiales y humanos. Entrega una coordenadas de ubicación de lo que se está monitoreando</p>
                                    <br><br><br><br>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4">
                        <img src="bootstrap/img/img3.jpg" class="img-responsive">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-offset-8">
                        <img src="bootstrap/img/img2.jpg" class="img-responsive">
                    </div>
                </div>
        ...
        <div id="informacion">
            ...
            <div class="container">
                <p class="txt">Localizadores satelitales:
                    Sistema de alertas por grupo, vehículo, evento, sitio de interés, geocerca, ruta, mantenimiento, entre otras
                </p>
            </div>
            <!-- <div class="divisor"></div> -->
            <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        ...
        <div id="contacto">
            ...
            <!-- <img src="img/img1.jpg" alt="" class="img-responsive fondo"> -->
            <div class="container">
                <p class="txt">Comunicate con nosotros! puedes enviar un correo, llamarnos a nuestros telefonos o ingresando tus datos y no sotros 
                    nos pondremos en contacto con usted y su compañia.</p>
                <br><br>
                <div class="row">
                    ...
                    <div class="hidden-xs hidden-sm col-md-2 col-md-offset-2">
                        <img src="bootstrap/img/img_contacto.png" class="img-responsive">
                    </div>
                </div>
        ...
        <div id="ingresar">
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <form class="form-horizontal" action="index.php">
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <input type="text" class="form-control input-lg" placeholder="Correo" name="usuario">
                                </div>
                            </div>
                            <div class="form-group">
                                <!-- clase control-label para alinear los label a la derecha -->
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <input type="password" class="form-control input-lg" placeholder="Contraseña" name="contrase_na">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <div class="hidden-xs hidden-sm col-md-2 col-md-offset-2">
                        <img src="bootstrap/img/img_ingresar.png" class="img-responsive">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="hidden-xs hidden-sm col-md-2 col-md-offset-10">
                        <img src="bootstrap/img/img_registro.png" class="img-responsive">
                    </div>
                </div>
      ...
      <!--<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>-->
        <script>window.jQuery || document.write('<script src="bootstrap/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>
...
if (isset($_GET['submitingresar'])) {
    $correo = $_GET['usuario'];
    $contrase_na = $_GET['contrase_na'];
    $login = new Login();
    // echo "<script>alert('Enviar: ".$correo." - ".$contrase_na."');</script>"; 
    $inicio = $login->validar($correo, $contrase_na);
    if ($inicio['status']) {
        echo "<script LANGUAGE='JavaScript'>
              ...
              setTimeout ('redireccionar()', 2);
            </script>";
        //print_r(headers_list());
    } else {
        //echo "<script>alert($inicio[mensaje];);</script>";
        echo "<script>alert('".$inicio['mensaje']."');</script>"; 
        //echo "<script>alert('No fue posible iniciar sesion');</script>";
        echo "<script LANGUAGE='JavaScript'>
